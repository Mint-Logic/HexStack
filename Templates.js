        ...
        <div class="settings-main">
            ...
            <div id="tab-about" class="tab-pane active">
                <div style="text-align: center; padding: 0px 0 10px 0;">
                    ...
                    ` : `
                    <div class="license-active-badge" style="display:flex; align-items:center; justify-content:center; gap:8px; padding: 6px 15px; background: rgba(187, 134, 252, 0.1); border: 1px solid var(--accent); border-radius: 20px; margin: 8px auto 10px auto; width: fit-content;">
                ...
                <div class="setting-group" style="border: 1px solid #333; background: rgba(255,255,255,0.01); border-radius: 6px; padding: 15px 20px; text-align: left; margin: 15px auto 10px auto; max-width: 530px; box-shadow: inset 1px 1px 3px rgba(0,0,0,0.3);">
                    ...
                    <p style="color: #ccc; font-size: 11.5px; line-height: 1.6; margin: 0;">
                        HexStack operates strictly offline. We do not track usage or collect analytics. Your color data, custom palettes, and design assets never leave your local hardware. The only time HexStack connects to the internet is a single, one-time ping during Pro activation to verify your license.
                    </p>
                </div>
            ...
            ${IS_DEV ? `
                <div class="setting-group" style="padding: 10px; border-radius: 6px; margin-bottom: 20px; background: rgba(255, 0, 127, 0.05); border: 1px dashed #FF007F;">
                    ...
                    <div class="setting-row" style="margin-bottom: 0;">
                        <div class="setting-label" style="color: #FF007F;">Simulate Core Mode <div class="setting-desc" style="color: rgba(255, 255, 255, 0.7);">Force-disable Pro features for UI testing.</div></div>
