...
function updatePicker() {
    ...
    label.innerHTML = `
        ...
        <span style="color: #fff; text-shadow: 0 1px 2px rgba(0,0,0,0.8); letter-spacing: 0.5px;">${hex} <span style="opacity: 0.5; font-size: 10px; margin-left: 4px;">(${ZOOM_LEVEL}x)</span></span>
    `;
